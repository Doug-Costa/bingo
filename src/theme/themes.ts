...
// ─── Tema 04 — Premium / Bingo Show (Ciano e Ouro Neon) ──────────────────────
export const tema04: ThemeTokens = {
  bgColor:         '#00113c',
  panelBg:         'rgba(0, 24, 76, 0.65)',
  headerBg:        'rgba(0, 16, 52, 0.8)',
  glassBg:         'rgba(0, 36, 112, 0.4)',

  primary:         '#00d4ff', // ciano neon brilhante
  primaryGlow:     'rgba(0, 212, 255, 0.4)',
  secondary:       '#00ff88', // verde neon secundário
  accent:          '#ffcc00', // amarelo ouro para destaques
  jackpotText:     '#ffd700', // ouro metálico

  ballBg:          '#ffd700',
  ballText:        '#000000',

  countdownBg:     'rgba(0, 17, 60, 0.8)',
  countdownText:   '#ffd700',

  borderPrimary:   '#00d4ff',
  borderSecondary: 'rgba(0, 212, 255, 0.25)',
  borderMuted:     'rgba(0, 212, 255, 0.1)',

  textPrimary:     '#ffffff',
  textSecondary:   '#8cb0ff', // azul claro para legendas
  textMuted:       '#5379c6',
  ...
  gridDrawn:       '#00d4ff',
  gridCurrent:     '#ffcc00',
  gridEmpty:       'rgba(0, 17, 60, 0.6)',
};

// ─── Resolver chave do tema ────────────────────────────────────────────────────
export function getThemeKey(themeInput?: any): 'tema01' | 'tema02' | 'tema03' | 'tema04' {
...
export const TEMA_GRADIENTS = {
  ...
  tema04: {
    bg:      ['#00113b', '#00081d'],
    ball:    ['#fff280', '#ffd700', '#c29600'],
    prize1:  ['#00d4ff', '#004c99'],
    prize2:  ['#002b80', '#001140'],
    prize3:  ['#001140', '#00081a'],
    header:  ['#001034', '#000c28'],
  },
} as const;
